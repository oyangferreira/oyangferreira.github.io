...
function mudarIdioma() {
  ...
  if (isEnglish) {
    ...
    subtitulo.textContent = "Desenvolvedor Front-end";
    descricao.textContent = "Sou um profissional com experiência diversificada em desenvolvimento de software e educação tecnológica. Atualmente atuo como desenvolvedor front-end, me especializando em Javascript, React Native e Firebase.";

    aboutTitulo.textContent = "Sobre mim";
    aboutSubtitulo.textContent = "Minha introdução";
    aboutDescricao.textContent = "Comecei minha carreira como professor de tecnologia lecionando para diferentes faixas etárias. Possuo técnico em Desenvolvimento de Sistemas e em Programação de Jogos Digitais. Meu objetivo é criar soluções impactantes, explorando novas tecnologias e contribuindo para projetos desafiadores.";
    ...
    menuItens[0].innerHTML = '<i class="uil uil-estate nav__icon"></i> Início';
    menuItens[1].innerHTML = '<i class="uil uil-user nav__icon"></i> Sobre mim';
    menuItens[2].innerHTML = '<i class="uil uil-file-alt nav__icon"></i> Habilidades';
    menuItens[3].innerHTML = '<i class="uil uil-briefcase-alt nav__icon"></i> Experiência';
    menuItens[4].innerHTML = '<i class="uil uil-scenery nav__icon"></i> Projetos';
    menuItens[5].innerHTML = '<i class="uil uil-message nav__icon"></i> Contato';

    // Traduzir botão "Contate-me"
    contactButton.innerHTML = 'Contate-me <i class="uil uil-message button__icon"></i>';
    ...
    contactButton.innerHTML = 'Contact me <i class="uil uil-message button__icon"></i>';
    // Se estiver em português, muda para inglês
    titulo.textContent = "Hello, I'm Yang!";
    subtitulo.textContent = "Front-end Developer";
    descricao.textContent = "I am a professional with diverse experience in software development and technology education. I currently work as a developer front-end, specializing in Javascript, React Native and Firebase.";

    aboutTitulo.textContent = "About";
    aboutSubtitulo.textContent = "My introduction";
    aboutDescricao.textContent = "I started my career as a technology teacher teaching different age groups. I have a technician in Systems Development and Digital Game Programming. My goal is to create impactful solutions, exploring new technologies and contributing to challenging projects.";
    ...
    // Mudar textos do menu
    menuItens[0].innerHTML = '<i class="uil uil-estate nav__icon"></i> Home';
    menuItens[1].innerHTML = '<i class="uil uil-user nav__icon"></i> About';
    menuItens[2].innerHTML = '<i class="uil uil-file-alt nav__icon"></i> Skills';
    menuItens[3].innerHTML = '<i class="uil uil-briefcase-alt nav__icon"></i> Experience';
    menuItens[4].innerHTML = '<i class="uil uil-scenery nav__icon"></i> Projects';
    menuItens[5].innerHTML = '<i class="uil uil-message nav__icon"></i> Contact';
